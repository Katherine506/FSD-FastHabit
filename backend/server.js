...
app.use("/api", require("./routes/registro.route"));
app.use("/api", require("./routes/recetas.route"));
app.use("/api", require("./routes/pesos.route"));
app.use('/api', require('./routes/ayunos.route'));
app.use('/api', require('./routes/actividades.route'));
app.use('/api', require('./routes/objetivos.route'));